...
fn main() -> Result<()>{
    ...
    env_logger::Builder::from_env(Env::default()
        .default_filter_or("spool_network=trace,spool_client=trace".to_string())).init();
    ...
    rt.block_on(run_spoolnet_cli())
}


async fn run_spoolnet_cli() -> Result<()> {

    log::print_title(format!("⊙⊙ SPOOLNET {}", env!("CARGO_PKG_VERSION")).as_str());
