...
use spool_client::{register::register_miner, get_miner_account};
use spool_network::{
    archive,
    mine::mine_loop,
    web::web_loop,
...
const DEVNET: &str = "https://devnet.spoolnet.io/api";
...
pub async fn handle_register(
    ...
    log::print_title(&format!("spoolnet get-miner {miner_address}"));
    log::print_divider();
    Ok(())
}
