...
fn test_airdrop() {
    ...
    let airdrop_amount = 500 * ONE_SPOOL; // 500 SPOOL
    ...
    let large_amount = 1_000_000 * ONE_SPOOL; // 1,000,000 SPOOL
    ...
    let new_airdrop_amount = 1000 * ONE_SPOOL; // 1000 SPOOL
    ...
    let third_airdrop_amount = 750 * ONE_SPOOL; // 750 SPOOL
